CREATE TABLE Bulb_RM.dbo.Closurecodes
(
Code varchar(50) ,
...
-- if client recall on account is different to supplier closure, which one should we use in the client closure?
-- TBC by Ant
